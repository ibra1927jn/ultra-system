#!/usr/bin/env node
// ╔══════════════════════════════════════════════════════════╗
// ║  ULTRA SYSTEM — Rebuild / Migrate DB                     ║
// ║  Idempotente: seguro de ejecutar sobre datos existentes  ║
// ║                                                          ║
// ║  Uso:                                                    ║
// ║    node scripts/rebuild_db.js                            ║
// ║    docker exec ultra_engine node scripts/rebuild_db.js   ║
// ╚══════════════════════════════════════════════════════════╝

// Carga variables de entorno si existe .env (para ejecucion local)
try { require('dotenv').config({ path: require('path').resolve(__dirname, '..', '.env') }); } catch (_) { /* sin dotenv en produccion */ }
...
// ─── SQL de migracion completa ──────────────────────────
// Todas las tablas de todos los pilares, idempotente
const MIGRATION_SQL = `

-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  ENUMS (idempotentes con DO/EXCEPTION)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  P4: BUROCRACIA — Alertas de Documentos
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- Columna de score en articulos RSS (idempotente)
DO $$ BEGIN
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  P5: OPORTUNIDADES — Freelance, ideas, negocios
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  P6: LOGISTICA — Transporte, alojamiento, citas
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  P7: BIO-CHECK — Salud y bienestar
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--  INDICES (todos idempotentes con IF NOT EXISTS)
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
// ─── Tablas esperadas para verificacion ──────────────────
const EXPECTED_TABLES = [
  'document_alerts', 'user_status', 'notification_log', 'uploaded_files',
  'rss_feeds', 'rss_articles', 'rss_keywords',
  'job_sources', 'job_listings',
  'finances', 'budgets',
  'opportunities',
  'logistics',
  'bio_checks',
...
async function run() {
  console.log('╔══════════════════════════════════════════════════════════╗');
  console.log('║  ULTRA SYSTEM — DB Migration                            ║');
  console.log('╚══════════════════════════════════════════════════════════╝');
  console.log('');
  ...
  try {
    ...
    console.log('[1/3] Ejecutando migracion...');
    await client.query(MIGRATION_SQL);
    console.log('      OK — SQL ejecutado sin errores');

    // Verificar tablas creadas
    console.log('[2/3] Verificando tablas...');
    ...
    for (const table of EXPECTED_TABLES) {
      const found = existing.includes(table);
      console.log(`      ${found ? 'OK' : 'FALTA'} — ${table}`);
      if (!found) allGood = false;
    }

    // Verificar indices
    console.log('[3/3] Verificando indices...');
    const idxResult = await client.query(
      `SELECT indexname FROM pg_indexes WHERE schemaname = 'public' ORDER BY indexname`
    );
    const indexCount = idxResult.rows.length;
    console.log(`      ${indexCount} indices encontrados`);

    // Resumen
    console.log('');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    if (allGood) {
      console.log('  RESULTADO: Migracion exitosa — todas las tablas verificadas');
    } else {
      console.log('  RESULTADO: Migracion con advertencias — revisar tablas faltantes');
      process.exitCode = 1;
    }
    console.log(`  Tablas: ${existing.length} | Indices: ${indexCount}`);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
